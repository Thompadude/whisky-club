...
<div class="content">
	...
	<h3 id="abc">ABC</h3>
		<ul class="listPictures">
			<li>
				<!-- TODO add comment what this do -->
				<a href="ListHandler?whisky=talisker">
				<img class="img-responsive" src="${pageContext.request.contextPath}/images/talisker.jpg" alt="Talisker">
				</a>
				<p>Talisker</p>
			</li>
		</ul>
	...
	<ul class="listPictures">
		<li>
			<a href=""> <img class="img-responsive" src="${pageContext.request.contextPath}/images/imageComingSoon.jpg" alt="Coming Soon"></a>
			<p>Coming Soon</p>
		</li>
	</ul>
	<div class="clear"></div>
	...
	<ul class="listPictures">
		<li>
			<a href="ListHandler?whisky=laphroaig">
			<img class="img-responsive" src="${pageContext.request.contextPath}/images/laphroaigquartercask.jpg" alt="Talisker">
			</a>
			<p>Laphroaig</p>
		</li>
	</ul>
